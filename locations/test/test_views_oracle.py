...
class TestOracleViews(unittest.TestCase):
    ...
    def test_views_schema_all(self):
        ...
        job = base_job.Job(os.path.join(os.getcwd(), 'views_wildcard_all_oracle.json'))
        job.connect_to_database()
    ...
    def test_views_schema_user(self):
        ...
        job = base_job.Job(os.path.join(os.getcwd(), 'views_wildcard_user_oracle.json'))
        job.connect_to_database()
    ...
    def test_views_wildcards(self):
        ...
        job = base_job.Job(os.path.join(os.getcwd(), 'views_include_exclude_oracle.json'))
        job.connect_to_database()
