...
dll_path = r'C:\voyager\server_2-1381\app\arch\win32_x86' #os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), '..', 'arch', 'win32_x86'))
gdal_path = r'C:\voyager\server_2-1381\app\gdal' #os.path.abspath(os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(__file__))), '..', 'gdal'))
